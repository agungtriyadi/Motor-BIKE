...
<html lang="en">
  <head>
    ...
    <!-- custom Magfira -->
    <link rel="stylesheet" href="{{asset('assets/css/pemilik.css')}}">
...
<!-- /WhatsHelp.io widget -->
    ...
    <script src="{{asset('assets/Jquery/swiper.js')}}"></script>
...
<script>
  ...
  function closeNav() {
    ...
    <!-- Optional JavaScript -->
    <script type="text/javascript" src="{{asset('assets/Jquery/script.js')}}"></script>
