...
<table width="100%" border="0">
  <tbody>
    <tr>
      ...
      <font style="color: gray">  <h2>PURI ASIH</h2></font>
      </td>
    </tr>
  <!--isi deskripsi start-->
    <tr>
  ...
  <!--tab foto start-->
        <div class="tab-content">
          <div class="tab-pane fade show active bg-white bg-white" id="foto" role="tabpanel" aria-labelledby="home-tab">
  <!--corausel foto start-->
            ...
            <div class="container" style="padding-top: 10px;">
              <div class="card-deck mb-3 text-left">
                <div class="card mb-4 shadow-sm">
                  ...
                  <div class="card-body"> 
            <h2 class="card-title pricing-card-title">IDR. 350.000 
    ...
    <tr>
      <td height="38" >
        <div style="padding-left: 10px">
          <div class="tab-content">
            <div class="tab-pane fade show active bg-white" id="fasilitas" style="borde-radius:20px;" role="tabpanel" aria-labelledby="home-tab">
<table width="100%" border="0" class="table-striped bg-white">
  <tbody>
    <tr>
