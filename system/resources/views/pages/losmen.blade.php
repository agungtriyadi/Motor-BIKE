...
<table width="100%" border="0">
  <tbody>
    <tr>
      ...
      <font style="color: gray">  <h2>LOSMEN BIKIN ENAK</h2></font>
      </td>
    </tr>
  <!--isi deskripsi start-->
    <tr>
  ...
  <!--tab foto start-->
        <div class="tab-content">
          <div class="tab-pane fade show active bg-white" id="foto" role="tabpanel" aria-labelledby="home-tab">
  <!--corausel foto start-->
    ...
    <!--nav deskripsi start-->
    <tr>
      <td colspan="2" style="bgcolor:lightgray">
    ...
    <tr>
      <td width="70%" height="50" > 
        ...
        <td style="align:center" class="bg-info" rowspan="2">
          <font style="color: white: 20px">
            <h2>Data Kos</h2>
          </font> 
            ...
            <div class="card-body">
              <h2 class="card-title pricing-card-title">IDR. 250.000 
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h6 class= "modal-title text-center" >Amanda Kos</h6> 
              ...
              <form>
                <div class="form-group">
                    <table style="border:0px; align:center" width="500px" class="tdl " >
              <tr >
                  <td >Paket</td>
                  <td><strong>:</strong></td>
                  <td>
    ...
    <tr>
      <td height="38" >
        <div style="padding-left: 10px">
          <div class="tab-content">
            <div class="tab-pane fade show active bg-white" id="fasilitas" role="tabpanel" aria-labelledby="home-tab">
<table width="100%" style="border:0" class="table-striped bg-light">
  <tbody>
    <tr>
